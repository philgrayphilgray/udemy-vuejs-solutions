    ...
    .card-text
      .row
        .col-sm-12.col-md-6.text-center
          button.btn.btn-primary(@click='onAnswer(btnData[0].correct)') {{ btnData[0].answer }}
        .col-sm-12.col-md-6.text-center
          button.btn.btn-primary(@click='onAnswer(btnData[1].correct)') {{ btnData[1].answer }}
      .row
        .col-sm-12.col-md-6.text-center
          button.btn.btn-primary(@click='onAnswer(btnData[2].correct)') {{ btnData[2].answer }}
        .col-sm-12.col-md-6.text-center
          button.btn.btn-primary(@click='onAnswer(btnData[3].correct)') {{ btnData[3].answer }}
